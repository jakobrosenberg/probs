...
/**
 * if all states are equal, returns the shared state value, otherwise returns 'started'
 * @param {...State} states
 * @returns {State}
 */
export const getPrevailingSTate = (...states) =>
    states.every(state => state === states[0]) ? states[0] : 'started'
