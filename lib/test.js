...
import { createHooksCollection } from "./utils.js"
...
export const createTest = (parentScope = [], { options, hooks }, parentPromiseQueue = []) => {
    ...
    const test = async (msg, cb) => {
        const promise = new Promise(async (resolve) => {
            ...
            if (runTest) {
                const nestedTest = createTest(scope, { options, hooks: scopedHooks }, pendingChildren)
                ...
                const context = { scope, ...scopedHooks }
